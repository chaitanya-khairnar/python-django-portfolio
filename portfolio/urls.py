...
urlpatterns = [
    ...
    path('password_change/', admin.site.password_change),
    path('', home.views.home, name='home'),
    path('home_base', home.views.BASE, name='home_base'),
    ...
    path('projects/<int:project_id>', home.views.detail, name='detail'),
]
